  ...
  return (
    <footer className="py-5 text-white bg-dark">
      <div className="container">
        ...
        <div className="row spotlight py-4 text-center">
          <div className="col-md-4">
            <div className="d-flex justify-content-center align-items-center">
              ...
              <h6 className="ps-2">Free Delivery</h6>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="d-flex justify-content-center align-items-center">
              ...
              <h6 className="ps-2">Money Back Guarantee</h6>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="d-flex justify-content-center align-items-center">
              ...
              <h6 className="ps-2">Secure Payment</h6>
            </div>
          </div>
        </div>
